...
# Step 7
# Setup connection with QT

# PORT AND IP
qtpc_ip = '192.168.100.4'  # QtPC's IP address
port = 12345  # Must match QtPC's receiver
...
try:
    ...
    while acquisition_running:
        ...
        # Create a socket/connection to QT and send the command
        sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        sock.connect((qtpc_ip, port))
