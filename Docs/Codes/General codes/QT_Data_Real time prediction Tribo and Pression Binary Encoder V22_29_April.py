        ...
        if processing_started and len(live_buffer) >= window_size:
            ...
            if current_time - last_prediction_time >= 0.05:
                ...
                if len(live_buffer) >= 40:                                  
                    ...
                    last_samples['Capteur Triboélectrique LA'] = last_samples['Capteur Triboélectrique LA'] - 50
                    last_samples['Capteur Triboélectrique RA'] = last_samples['Capteur Triboélectrique RA'] - 150
                    last_samples['Capteur Triboélectrique BA'] = last_samples['Capteur Triboélectrique BA'] - 200
